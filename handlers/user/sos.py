...
async def cmd_sos(message: Message):
    ...
    await message.answer("В чём суть проблемы? Опишите как можно детальнее и администратор обязательно вам ответит.",
