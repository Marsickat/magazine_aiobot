...
from aiogram.types import Message, ChatActions, InlineKeyboardMarkup, InlineKeyboardButton, CallbackQuery, \
    ReplyKeyboardRemove
...
async def process_questions(message: Message):
    ...
    if len(questions) == 0:
        ...
        for cid, question in questions:
            ...
            markup.add(InlineKeyboardButton("Ответить", callback_data=question_cb.new(cid=cid, action="answer")))
